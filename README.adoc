...
[ ![Download](https://api.bintray.com/packages/agile-lab-dev/Spark-Solr/spark-solr/images/download.svg?version=3.8.0) ](https://bintray.com/agile-lab-dev/Spark-Solr/spark-solr/3.8.0/link)
